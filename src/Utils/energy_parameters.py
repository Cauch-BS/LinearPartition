...
stacks = jnp.full((8, 8), float('inf')).at[1:, 1:].set(jnp.array([
...
bulges = jnp.array([ # array of length 31
    float('inf'),   # Bulges are larger than 0
...
internal_loop = jnp.array([ # for 1 * n loops (1 * 1 and 1 * 2 loops are considered seperately)
    float('inf'),  float('inf'), # Internal loops are larger than 1
